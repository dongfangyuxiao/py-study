...
class subDomainsBrute():
    ...
    def system(self):
        ...
        try:
            ...
            a = subprocess.Popen('python subDomainsBrute.py  -o /root/project/info/subDomainsBrute.txt  ' + self.domain,shell=True
...
if __name__ == "__main__":
    search = subDomainsBrute("taobao.com")
    print search.run()
